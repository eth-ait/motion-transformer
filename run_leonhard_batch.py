...
transformer_experiments = [
    ...
    '--glog_comment "shared_ffn-rand100_mask01" '
    '--shared_pw_ffn '
    ...
    'python spl/training.py '
    '--glog_comment "shared_emb_ffn" '
    '--shared_embedding_layer --shared_pw_ffn '
    '--random_window_min 0 --temporal_mask_drop 0 '
    '--transformer_window_length 120 --transformer_num_layers 8 '
    '--transformer_d_model 128 --transformer_dff 256 ',
    
    'python spl/training.py '
    '--glog_comment "shared_emb_ffn-rand100_mask01" '
    '--shared_embedding_layer --shared_pw_ffn '
    '--random_window_min 100 --temporal_mask_drop 0.1 '
    '--transformer_window_length 120 --transformer_num_layers 8 '
    '--transformer_d_model 128 --transformer_dff 256 ',
    ...
    'python spl/training.py '
    '--glog_comment "shared_block-rand100_mask01" '
...
transformer_h36m = [
    'python spl/training.py '
    '--glog_comment "shared_emb_temp_spat_ffn-rand40_mask01" '
    '--shared_embedding_layer '
    ...
    'python spl/training.py '
    '--glog_comment "shared_emb_temp_spat_ffn_block-rand40_mask01" '
    ...
    'python spl/training.py '
    '--glog_comment "shared_emb_temp_spat_ffn_block" '
    '--shared_embedding_layer --shared_attention_block '
    '--shared_temporal_layer --shared_spatial_layer --shared_pw_ffn '
    '--num_epochs 10000 --use_h36m --source_seq_len 50 --target_seq_len 10 '
    '--random_window_min 0 --temporal_mask_drop 0 '
    ...
    'python spl/training.py '
    '--glog_comment "shared_emb_temp_spat_ffn_block_out" '
    '--shared_embedding_layer --shared_attention_block '
    '--shared_temporal_layer --shared_spatial_layer --shared_pw_ffn '
    '--shared_output_layer '
    '--num_epochs 10000 --use_h36m --source_seq_len 50 --target_seq_len 10 '
    ...
    'python spl/training.py '
    '--glog_comment "shared_emb_temp_spat_ffn_out" '
    '--shared_embedding_layer '
    '--shared_temporal_layer --shared_spatial_layer --shared_pw_ffn '
    '--shared_output_layer '
    '--num_epochs 10000 --use_h36m --source_seq_len 50 --target_seq_len 10 '
