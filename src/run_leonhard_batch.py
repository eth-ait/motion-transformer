...
experiment_list_h36m = [
    'python amass_training.py --input_dropout_rate 0.0 --learning_rate 0.001 --batch_size 64 --optimizer adam --angle_loss joint_sum --model_type rnn --output_layer_size 256 --output_layer_number 1 --joint_prediction_model plain --cell_type lstm --cell_size 1024 --cell_layers 1 --test_every 500 --seq_length_in 120 --seq_length_out 24 --residual_velocities --dynamic_validation_split --autoregressive_input sampling_based --use_quat --no_normalization --force_valid_rot',
