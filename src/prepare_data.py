"""
Copyright (c) ETH Zurich, Emre Aksan, Manuel Kaufmann
"""
import argparse
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument("--split_dir", required=True, help="Where the text files defining the data splits are stored.")
